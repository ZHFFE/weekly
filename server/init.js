...
// 生产环境的配置文件
const prodEnvList = ['production', 'test', 'uat', 'prev', 'demo'];
...
global.ENV_CONFIG = util.extend(commonConf, require(`../config/env/${SERVER_ENV}`));
...
const views_path = path.join(__dirname, prodEnvList.indexOf(SERVER_ENV) != -1 ? '../build/' : '../build/');
